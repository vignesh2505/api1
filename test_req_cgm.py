...
def test_post_request(token):
    url = "https://sustainium-dev.12thwonder.com/api/app/capital-goods-management"
    payload = {
        "emissionFactorTypeId": "3a10f724-4317-c054-0a53-757c1be6f7b9",
        ...
        "monthsData": {"2025-2025": 11000},
        "description": "test1",
        "emissionSourceId": "7893f048-98c0-4e4b-bef7-4054d1f0961",
	    "currencyId": "7266bf60-9a73-4e22-b1a1-a570bea60100",
        "currencyIdAndCode" : "7266bf60-9a73-4e22-b1a1-a570bea60100_AUD",
...
def test_delete_request(token, resource_id):
    url = f"https://sustainium-dev.12thwonder.com/api/app/capital-goods-management/{resource_id}"
    headers = {
        "tenantIdentifier": TENANT_IDENTIFIER,
        "Authorization": f"Bearer {token}"
    }
