...
def test_post_request(token):
    url = "https://sustainium-dev.12thwonder.com/api/app/electricity-management"
    payload = {
        ...
        "description": "test1",
        "emissionSourceId": "292a0d97-9c6e-4ad6-8493-cb8f6ec94825",
        "emissionUnitId": "3a116c7d-90e3-9fd9-d322-0ff3e6c64599"
    }
    headers = {
...
def test_delete_request(token, resource_id):
    url = f"https://sustainium-dev.12thwonder.com/api/app/electricity-management/{resource_id}"
    headers = {
        "tenantIdentifier": TENANT_IDENTIFIER,
        "Authorization": f"Bearer {token}"
    }
